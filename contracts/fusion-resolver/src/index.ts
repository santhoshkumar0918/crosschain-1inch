...
class FusionResolver {
  ...
  constructor() {
    ...
    this.dutchAuction = new DutchAuction(this.orderBook, this.htlcManager);
  }
  ...
  private setupRoutes(): void {
    // API routes
    this.app.use('/api/fusion-plus', createFusionRoutes(
      this.orderBook,
      this.dutchAuction,
      this.htlcManager,
  ...
  async start(): Promise<void> {
    try {
      ...
      const server = this.app.listen(config.port, () => {
        ...
        this.logger.info(`📊 Health check: http://localhost:${config.port}/api/fusion-plus/health`);
        this.logger.info(`💱 Submit orders: http://localhost:${config.port}/api/fusion-plus/submit`);
        this.logger.info(`📋 View orders: http://localhost:${config.port}/api/fusion-plus/orders`);
        this.logger.info(`📈 Statistics: http://localhost:${config.port}/api/fusion-plus/stats`);
